...
<body>
      ...
      <div class="sidenav">
        ...
        <div class="dropdown-container">
          ...
          <a href="product-inventory.php" class="nav-active"><i class="fa-solid fa-boxes-stacked"></i>Inventory</a>
      ...
      <div class="main">
        ...
        <table class="product-table table table-striped mt-4">
              ...
              <tbody id="results" class="h6">
                <?php
                    $sql = "SELECT * FROM tblinventory ORDER BY expiration_date ASC";
                    $result = $conn->query($sql);
                ...
                ?>
                            ...
                            <tr>
                                ...
                                <td class="action-btn">
                                  <?php echo "<a href='#'><i class='fa-solid fa-pen-to-square'></i></a>"?>
                                  <?php echo "<a href='#'><i class='fa-solid fa-trash-can'></i></a>"?>
